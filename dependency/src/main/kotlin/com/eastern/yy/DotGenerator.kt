...
internal class DotGenerator(
        ...
        private val generator: DependencyGraphGeneratorExtension.Generator
) {
    ...
    private val nodeMap = mutableMapOf<String, Artifact>()
    ...
    private fun append(dependency: ResolvedDependency, parentIdentifier: String, graph: MutableGraph) {
        ...
        var artifact = nodeMap[identifier]
        if (artifact == null) {
            artifact = Artifact()
